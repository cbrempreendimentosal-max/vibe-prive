            ...
            <tbody className="divide-y divide-gray-50">
              {anunciante.transacoes.map((t) => (
                <tr key={t.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-5 py-3 text-sm text-violet-600">{formatCurrency(t.taxaProcessamento)}</td>
                  <td className="px-5 py-3 text-sm font-semibold">{formatCurrency(t.totalCobrado)}</td>
